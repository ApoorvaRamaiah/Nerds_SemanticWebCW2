...
public Task_RDF_3_RDF_Triples_using_GoogleKG(String input_file, Map<String, Integer> column_index) throws IOException {
		...
		model.setNsPrefix("dbr", "http://googleKGLookup.org/resource/");
...
protected String getExternalKGURI(String name) throws JsonProcessingException, IOException, URISyntaxException {
    ...
    Set<KGEntity> entities = googleKGLookup.getEntities(name, "10", types, lang, 0.0);
...
public static void main(String[] args) {
	...
	try {
		Task_RDF_3_RDF_Triples_using_GoogleKG solution = new Task_RDF_3_RDF_Triples_using_GoogleKG(file, column_index);
