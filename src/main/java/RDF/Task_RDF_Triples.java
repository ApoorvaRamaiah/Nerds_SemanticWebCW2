...
public Task_RDF_Triples(String input_file, Map<String, Integer> column_index) throws IOException {
...
public static void main(String[] args) {
	...
	String file = "files/IN3067-INM713_coursework_data_pizza_500_new_entries.csv";
	...
	try {
		Task_RDF_Triples solution = new Task_RDF_Triples(file, column_index);
		...
		solution.saveGraph(solution.model, file.replace("IN3067-INM713_coursework_data_pizza_500_new_entries.csv",""+task)+".ttl");
