...
public Task_RDF_4_Reasoning(String input_file, Map<String, Integer> column_index) throws IOException {
...
public static void main(String[] args) {
	...
	String file = "files/IN3067-INM713_coursework_data_pizza_reduced.csv";
	...
	try {
		Task_RDF_4_Reasoning solution = new Task_RDF_4_Reasoning(file, column_index);
