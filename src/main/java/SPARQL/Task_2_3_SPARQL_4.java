...
public Task_2_3_SPARQL_4(String input_file, Map<String, Integer> column_index) throws IOException {
...
public void performSPARQLQuery(Model model, String file_query_out) {
	...
	String queryStr = 
			   ...
			   "SELECT ?city (COUNT(?restaurant) AS ?restaurantCount) WHERE {\n" +
	...
	try {
		...
		while( res.hasNext()) {
			...
			writer.writeLine(city.toString()+","+restaurantCount.toString());
...
public static void main(String[] args) {
	...
	try {
		Task_2_3_SPARQL_4 solution = new Task_2_3_SPARQL_4(file, column_index);
