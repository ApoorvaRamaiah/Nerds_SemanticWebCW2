...
public Task_2_3_SPARQL_3(String input_file, Map<String, Integer> column_index) throws IOException {
...
public static void main(String[] args) {
	...
	try {
		Task_2_3_SPARQL_3 solution = new Task_2_3_SPARQL_3(file, column_index);
