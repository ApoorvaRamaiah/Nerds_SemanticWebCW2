...
public Task_2_3_SPARQL_1(String input_file, Map<String, Integer> column_index) throws IOException {
   ...
   String queryStr = 
	...
	try {
		...
		while( res.hasNext()) {
			...
			writer.writeLine(restaurant.toString()+","+state.toString()+","+postcode.toString());
...
public static void main(String[] args) {
	...
	try {
		Task_2_3_SPARQL_1 solution = new Task_2_3_SPARQL_1(file, column_index);
