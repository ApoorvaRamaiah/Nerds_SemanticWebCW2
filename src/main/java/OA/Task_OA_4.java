...
public Task_OA_4(String input_file, Map<String, Integer> column_index) throws IOException {
...
public static void main(String[] args) {
	...
	try {
		...
		solution.performSPARQLQuery(solution.inf_model, file.replace("50_unique_data.csv", ""+task)+"-Sparql-query-results.csv");	
